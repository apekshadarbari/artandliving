...
(function () {
  ...
  popup.innerHTML = `
    ...
    <h3>Letters from<br>the studio (my newsletter).</h3>
    <p>Letters on my art, creativity, neurodivergence, what women carry, upcoming workshops, resources, and what we are building together. You'll only hear from me when there's something worth saying.</p>
